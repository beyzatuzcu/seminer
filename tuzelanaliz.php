...
<div id="analiz">
    ...
    <h3>Kurumsal Başvuru İtiraz Ekranı</h3><br>
  ...
  <div class="search-box">
    <input type="text" name="query" placeholder="Vergi Dairesi Arama">
...
$sql = "SELECT * FROM tuzel WHERE vergi_dairesi LIKE '%$query%'";
$result = mysqli_query($conn, $sql);

// Tabloyu yazdır
echo "<table>";
echo "<table><tr><th>Firma Adı</th><th>Vergi Dairesi</th><th>İl</th><th>Firma Adresi</th><th>Ticari Sicil No</th><th>Ticari Sicil Odası</th><th>Dilekçe Metni</th></tr>";

if (mysqli_num_rows($result) > 0) {
    while($row = mysqli_fetch_assoc($result)) {
        echo "<tr><td>".$row["firma_adi"]."</td><td>".$row["vergi_dairesi"]."</td><td>".$row["il"]."</td><td>".$row["firma_adresi"]."</td><td>".$row["ticari_sicil_no"]."</td><td>".$row["ticari_sicil_odasi"]."</td><td>".$row["dilekce_metni"]."</td></tr>";
    }
} else {
