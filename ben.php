...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  // Kullanıcının girdiği bilgileri değişkenlere kaydet
    ...
    $ilce = $_POST["ilce"];
    $adres = $_POST["adres"];
    $il_mudurlugu = $_POST["il_mudurlugu"];
    $dilekce_metni = $_POST["dilekce_metni"];

    // Veritabanına kaydetmek için sorgu hazırla
    $sql = "INSERT INTO kisiler (ad_soyad, tc_kimlik, cep_telefon, email, il, ilce, adres, il_mudurlugu, dilekce_metni) 
    VALUES ('$ad_soyad', '$tc_kimlik', '$cep_telefon', '$email', '$il', '$ilce', '$adres','$il_mudurlugu', '$dilekce_metni')";
...
<div>
    ...
    <div class="modal-bodies">
        ...
        <form action="#" method="post">
            <label for=""><span> Ad Soyad</span> <input type="text" id="ad_soyad" name="ad_soyad"></label>
            <label for=""><span>T.C Kimlik No</span> <input type="text" id="tc_kimlik" name="tc_kimlik" required></label>
            <label for=""><span>Cep Telefon</span> <input type="number" id="cep_telefon" name="cep_telefon"></label>
            <label for=""><span> E-Posta</span> <input type="text" id="email" name="email"></label>
            <label for=""><span>İl</span> <input type="text" id="il" name="il"></label>
            <label for=""><span>İlçe</span> <input type="text" id="ilce" name="ilce"></label>
            <label for=""><span>Adres</span> <input type="text" id="adres" name="adres"></label>
            <label for=""><span> İl Müdürlüğü </span> <input type="text" name="il_mudurlugu"></label>
    ...
    <a href="bireyselileri2.php"><div id="btn3">ileri</div></a>
